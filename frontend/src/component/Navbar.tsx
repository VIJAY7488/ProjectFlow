    ...
    <header className='sticky top-0 z-40 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60'>
      <div className="flex justify-between items-center h-14 px-4">
        <div className="flex justify-between items-center gap-2">
          ...
          <span className={`text-2xl font-bold ${isScrolled ? 'text-white' : 'text-black'}`}>
            ProjectFlow
          </span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="text-base font-medium px-4 py-2 bg-gradient-to-r from-sky-500 to-blue-600 text-white rounded-lg hover:opacity-90 transition-opacity duration-200">
            Get Started
          </button>
        </div>
      </div>
